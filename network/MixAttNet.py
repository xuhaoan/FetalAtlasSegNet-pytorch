...
def out_stage(in_chan, out_chan, num_class=1):
    return nn.Sequential(
...
class MixAttNet(nn.Module):
    def __init__(self):
        ...
        self.mix_out1 = nn.Conv3d(16, num_class, kernel_size=1)
        self.mix_out2 = nn.Conv3d(16, num_class, kernel_size=1)
        self.mix_out3 = nn.Conv3d(16, num_class, kernel_size=1)
        self.mix_out4 = nn.Conv3d(16, num_class, kernel_size=1)
        self.down_out1 = nn.Conv3d(16, num_class, kernel_size=1)
        self.down_out2 = nn.Conv3d(16, num_class, kernel_size=1)
        self.down_out3 = nn.Conv3d(16, num_class, kernel_size=1)
        self.down_out4 = nn.Conv3d(16, num_class, kernel_size=1)
